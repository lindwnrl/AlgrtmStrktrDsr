...
public class StackTugasMahasiswa17 {
    ...
    public void push (Mahasiswa17 mhs){
        if (!isFull()) {
            ...
            System.out.println("Stack penuh! Tidak bisa menambahakn tugas lagi.");
        }
    }
    ...
    public Mahasiswa17 peek(){
     ...
     public Mahasiswa17 reversePeek(){
        if (!isEmpty()) {
            return stack[0];
        }else{
            System.out.println("Stack kosong! Tidak ada tugas yang dikumpulkan");
    ...
    public void banyakTugas(){
        if (top < 0) {
            ...
            System.out.println("Banyaknya tugas yang terkumpul saat ini adalah : " + (top + 1));
        }
    }
    public void print(){
        for (int i = top ; i >= 0 ; i--) {
